...
namespace cypos
{
    public partial class frmCurrencyboard : Form
    {
        TextBox _TextBox;
        ...
        public frmCurrencyboard(TextBox tBox)
        {
            this.SuspendLayout();
            InitializeComponent();
            _TextBox = tBox;
            WireAllControls(curPad1);
        ...
        private void ctrl_Click(object sender, EventArgs e)
        {
            ...
            if (_TextBox != null)
            {
                ...
                _TextBox.Text = curPad1.KeyPadReturnValue;
            }
        }

        void textBox_Enter(object sender, EventArgs e)
        {
            curPad1.KeyPadReturnValue = _TextBox.Text;
        }
